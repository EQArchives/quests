function event_say(e)
	...
	elseif(e.message:findi("great sorcerer")) then
		if(e.other:GetFactionValue(e.self) >= 300) then
			...
			e.other:SummonCursorItem(17195); -- Item: A Flaxen Hilt -- 12887 is bugged version so the quest won't be completeable -- 17195 is fixed version to make quest completeable
		else
