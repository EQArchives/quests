...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 27262, item2 = 27263, item3 = 27264}))
	then
		e.other:QuestReward(e.self, {itemid = 27310, exp = 60000}); -- Item: Breezeboot's Frigid Gnasher
	end
