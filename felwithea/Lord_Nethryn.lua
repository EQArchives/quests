function event_say(e)
	...
	elseif(e.message:findi("to pry")) then
		e.self:Say("Very well, I do apologize if I did offend. May your travels be rewarding and Tunare's good grace upon you, " .. e.other:GetCleanName() .. "");
	...
	elseif(e.message:findi("accepted")) then
		e.self:Say("Those who have been found worthy in their deeds to accept recognition from the gods are given a [coin] that they may give to one of the many [heroes and servants] that the gods have recently returned to this realm.");
